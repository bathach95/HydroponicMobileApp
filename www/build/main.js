...
var ToastService = /** @class */ (function () {
    ...
    ToastService = __decorate([
        ...
        __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_0_ionic_angular__["h" /* ToastController */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_0_ionic_angular__["h" /* ToastController */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_0_ionic_angular__["d" /* LoadingController */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_0_ionic_angular__["d" /* LoadingController */]) === "function" && _b || Object])
    ], ToastService);
    return ToastService;
    var _a, _b;
}());
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__services_toast_service__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ionic_native_android_permissions__ = __webpack_require__(343);
...
var SmartConfigPage = /** @class */ (function () {
    ...
    SmartConfigPage.prototype.smartConfig = function (config) {
        ...
        var network = __WEBPACK_IMPORTED_MODULE_4_lodash__["find"](this.networks, ['ssid', config.ssid.trim()]);
        ...
        esptouch.start(network.ssid, network.bssid, config.password, isHiddenStr, config.count, function (res) {
            console.log(res);
            _this.stopSmartConfig();
            _this.toastService.showToast(res);
            _this.navCtrl.pop();
        }, function (err) {
            console.log(err);
            _this.toastService.showToast(err);
